...
export function RoutingMapBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none select-none z-0">
      ...
      */}
      <svg
        className="w-full h-full text-foreground/5 dark:text-foreground/5"
      ...
      >
        ...
        <g stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.15" strokeDasharray="4 8">
        ...
        <g fill="currentColor" fillOpacity="0.3" stroke="currentColor" strokeWidth="1" strokeOpacity="0.5">
          <circle cx="900" cy="100" r="3.5" className="fill-background" />
          <circle cx="1200" cy="300" r="2.5" />
          <circle cx="1100" cy="250" r="3" className="fill-background" strokeWidth="1.5" />
          ...
          <circle cx="1500" cy="700" r="4.5" className="fill-background" strokeWidth="1.5" />
        </g>
        ...
        <g fill="currentColor" stroke="currentColor" strokeWidth="1">
          ...
          <circle cx="1400" cy="300" r="4" className="text-accent fill-accent" />
          <circle cx="1400" cy="300" r="8" fill="none" className="text-accent/30" strokeWidth="1" />
          
          {/* Accent node 2 - Center-Right junction */}
          <circle cx="1300" cy="400" r="3.5" className="text-accent fill-accent" />

          {/* Accent node 3 - Bottom-Center */}
          <circle cx="900" cy="550" r="4.5" className="text-accent fill-accent" />
          <circle cx="900" cy="550" r="9" fill="none" className="text-accent/30" strokeWidth="1" />
        </g>

        {/* Technical/Editorial Labels */}
        <g fill="currentColor" fillOpacity="0.35" className="font-mono text-[9px] tracking-wider select-none">
          <text x="915" y="103">[SYS-NODE-01]</text>
          <text x="1215" y="303">[RT-JNC.08]</text>
          <text x="1415" y="303" className="text-accent fill-accent font-bold" fillOpacity="0.8">[ACC.FLOW]</text>
          ...
          <text x="915" y="553" className="text-accent fill-accent font-bold" fillOpacity="0.8">[ANCR-C]</text>
        </g>
      </svg>

      {/* Subtle overlay gradient to smoothly fade the background near the left edge for absolute text clarity */}
      <div className="absolute inset-0 bg-gradient-to-r from-background via-background/90 to-transparent w-[30%]" />
      {/* Bottom fade */}
