    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none select-none z-0">
      ...
      */}
      ...
      >
        ...
        <g stroke="currentColor" strokeWidth="0.75" strokeOpacity="0.05" strokeDasharray="4 8">
        ...
        {/* Faint route paths */}
        <g stroke="currentColor" strokeWidth="1.25" strokeOpacity="0.18">
        ...
        <g stroke="currentColor" strokeWidth="2" strokeOpacity="0.32">
        ...
        <g fill="currentColor" fillOpacity="0.15" stroke="currentColor" strokeWidth="1" strokeOpacity="0.35">
          <circle cx="900" cy="100" r="4" className="fill-background" />
          <circle cx="1200" cy="300" r="3" />
          <circle cx="1100" cy="250" r="3.5" className="fill-background" strokeWidth="1.5" />
          <circle cx="700" cy="400" r="2.5" />
          <circle cx="1100" cy="550" r="3" />
          <circle cx="1100" cy="600" r="2.5" />
          <circle cx="1300" cy="700" r="4" className="fill-background" />
          <circle cx="300" cy="700" r="3.5" />
          <circle cx="900" cy="650" r="3" />
          <circle cx="1300" cy="650" r="2.5" />
          <circle cx="1500" cy="100" r="3.5" />
          <circle cx="1500" cy="700" r="5" className="fill-background" strokeWidth="1.5" />
        </g>
        ...
        <g fill="currentColor" stroke="currentColor" strokeWidth="1">
          ...
          <circle cx="1400" cy="300" r="4.5" className="text-accent fill-accent" />
          <circle cx="1400" cy="300" r="9.5" fill="none" className="text-accent/40" strokeWidth="1" />
          
          {/* Accent node 2 - Center-Right junction */}
          <circle cx="1300" cy="400" r="4" className="text-accent fill-accent" />

          {/* Accent node 3 - Bottom-Center */}
          <circle cx="900" cy="550" r="5" className="text-accent fill-accent" />
          <circle cx="900" cy="550" r="10.5" fill="none" className="text-accent/40" strokeWidth="1" />
        </g>

        {/* Technical/Editorial Labels */}
        <g fill="currentColor" fillOpacity="0.3" className="font-mono text-[9px] tracking-wider select-none">
          <text x="915" y="103">[SYS-NODE-01]</text>
          <text x="1215" y="303">[RT-JNC.08]</text>
          <text x="1415" y="303" className="text-accent fill-accent font-semibold" fillOpacity="0.75">[ACC.FLOW]</text>
          ...
          <text x="915" y="553" className="text-accent fill-accent font-semibold" fillOpacity="0.75">[ANCR-C]</text>
        </g>
      </svg>
